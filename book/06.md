...
hegemony and legitimacy of the time of production_[
  ...
  subservient role of pseudo-cyclical time. See Debord's _Perspectives for
...
![
  **Figure 1** Spectacular Time
](var_bw_imagepath/time-and-history.png){#figure-1 .figure-1 data-external="1"}
...
activities, and the "all-inclusive" [luxury]{.ix} accommodations with pre-set
...
online shopping, pre-made or instant meal replacements,[
  ...
  Soylent, the minimalist liquid meal which I myself admit to drinking during
...
Spectacular time is the progression of linear time[
  ...
  a beautifully worded example of Debord's use of détournement, so I've included
...
labor,[
  dead labor / living labor: Dead labor is labor power that has been expended
  into a _thing_, a machine, a factory  or even an widget.Full quote: "If the
  extension of output maintained the given relationship between inputs of living
  labour and inputs of dead labour (machinery and raw materials)..." See Marx,
  K., Mandel, E., Fowkes, B. & Fernbach, D. (1978)
]{#fn156.1 .fn .fn-l .ix data-ix="labor, dead;labor, living"}
...
creation of time and history.[
  ...
  society, the present dominates the past." Ibid.
]{#fn156.2 .fn}
...
social absence of death is equal only to the social absence of life.
