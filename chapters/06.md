...
individual [spectator]{.ix data-ix="spectator"} trapped at the center of
...
remains in stasis, on-hold for the next spectacular [event]{.ix}. As such, we
...
]{#fn160.1 .fn .ix data-ix="The American Way of Death"}
...
through [aging]{.ix}. The [beauties and graces]{.ix data-ix="beauty;grace"} of
