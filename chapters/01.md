...
## I. Separation Perfected {title="Separation Perfected"}
...
lives[
  ...
  is later made in thesis 215; the full quotation reads: "Need for labor,
  elevated into this universality, then form on their own account a monstrous
  system of community and mutual interdependence in a great people; the life of
  the dead body, that moves itself within itself, one which ebbs and flows in
  its motion blindly, like the elements, and which requires continual strict
...
It comes in many forms, entertainment, academic discourse,
...
> former.": The original French is <q lang="fr">une seconde nature paraît
