...
> “Whoever becomes master of a city accustomed to live in freedom and does no
...
> cease to be remembered…” —Machiavelli, _The Prince_
...
guilds of the Middle Age assuring the _quality_ of craft production had to be
destroyed to make way for the era of mass production, just as it had to dissolve
the autonomy and quality of _places_. The cheap prices of its commodities are
the heavy artillery with which it batters down all Chinese walls.

> “it had to dissolve the autonomy and quality of places”: This is seen
...
> batters down all Chinese walls”: From the original French: “Cette puissance
> d’homogénéisation est la grosse artillerie qui a fait tomber toutes les
> murailles de Chine.” a direct reference to the Communist Manifesto, see Marx,
> K., Engels, F. & Jones, G. 2002 (Part 1)
...
landscape it finds itself within. Urbanism is capitalism's direct mode of
appropriation of natural and human environment. This capital appropriation
...
> Urbanism: The French word _urbanisme_ means “city planning” which has an
> impersonal and bureaucratic connotation. Broadly encompassing urban planning,
> real-estate development, and gentrification.

## 170

The drive to urbanization is an imperative of capitalism, this drive results in
“a freezing of life”. Described by Hegel as a predominance of “the peaceful
coexistence of space” over “a restless becoming in successive moments of time.”
...
> original Hegel “The Object thus posited as outside the subject and in its own
> self as an externality is partly the quiescent side-by-sideness of space,
> partly a restless becoming in the successive moments of time. Space and time
> are abstract intuitions or Universal Forms of Intuition.” Quote taken from
> Hegel, G.W.F., 1986 (Pp. 151 No. 136).

## 171

The technical apparatus of the forces of capitalism (television, internet social
media, government policy, and consumer products) should be understood as the
tools of separation: grouping people into exclusionary tribes as well as
alienating people from their labor and environment—exclusion from participation
in daily life. The technical apparatus of urbanization is the fundamental method
that makes all others possible—and far more efficient. Urbanization is the
creation and preparation of the territory upon which all other technical methods
are then deployed. It is the very _technology of separation_.
...
themselves. In his book _The City in History_, Lewis Mumford describes a
...
population under control” (Mumford, L., 1961). This system empowers those in
power to broadcast their historical perspectives and ideologies to an isolated
and alienated society who no longer has an ability to respond with its own voice
or even amongst each other. Urbanism is the general trend, a global movement to
...
urbanism isolates us together are in the factories, cultural centers (museums,
theaters, etc), vacation resorts, and housing developments—all explicitly
...
dominant the images of spectacular society become; and this is where the
spectacle acquires its full potential.
...
> enough form an army to march down.
...
> actual content of any single episode is personalized for each individual.) A
> possible site of resistance is the public display of personalized media. This
> could open a participatory public dialog where the individual can share their
> own spectacular world with wider society. Perhaps the most radical act would
> be to organize a public display of a scroll through personalized Instagram
> feeds, Youtube recommendations, a collection of internet ads, and to invite
> others to view your Netflix feed in public: a contemporary form of nudity.

## 173

Prior to the 20th century, innovations in architecture were exclusively designed
to serve the interests of the ruling class. Now, for the first time,
...
characterized by their _mass:_ mass-produced for ‘the masses’, dictated by the
contemporary conditions of production.

<figure>
  <img src="../images/al-ain.jpg">
  <figcaption>Al Ain City, a new housing development in Mbazzarah Al Khadra, Al Ain, Abu Dhabi, United Arab Emirates. Photo by Andrzej Bochenski. Lodz, Poland.
  </figcaption>
</figure>
...
Mumford calls “a formless mass of thinly spread semi-urban tissue”. This
explosion is exemplified by strip malls, restaurant franchises, and landscapes
developed to serve the required efficiencies of automobile-oriented consumption.
...
ever-growing flat expanse. Meanwhile, the countryside is developed ad-hoc around
...
> Kunstler gave an insightful and funny TED talk on the topic called “The
> ghastly tragedy of the suburbs”, see Kunstler, J. H., 2004.
...
town and the country, created a race to equilibrium such that a distinction
...
refuses to progress—privileges the development of the independent goals of the
...
that it “subjected the country to the towns”, whose “very air is liberating.”
...
> “very air is liberating”: Quote is from the German "Stadtluft macht frei" or
> "city air liberates" a medieval German saying, expressing that fact that serfs
> could free themselves from their ties to the landed gentry by escaping to the
> towns.

## 177

“The country demonstrates just the opposite fact: isolation and separation” (as
...
attachment to nature, and any of the social aspects of either traditional
farming villages or the mixtures of culture apparent in the organic city have
been lost. This new condition of “urban redevelopment”, that densely packed and
yet separate and isolated environments produces a new artificial peasantry.
These new peasants are molded by their physical conditions and the influence of
the spectacle: where once peasants were isolated by physical distance now find
...
the Chinese state bureaucracy, a form of “oriental despotism” which, because of
...
well as _historically fabricated_. Simple ignorance has been replaced by the
organized spectacle of falsehoods. These “new cities” of pseudo-countryside, the
...
> “oriental despotism”: See Wittfogel, K., 1981.

> “the organized spectacle of falsehoods”: A rewording of the original French,
> “l’ignorance naturelle a fait place au spectacle organisé de l’erreur” or an
> “natural ignorance has given way to the organized spectacle of error”. The
> original phrasing was very abstract, I’ve tried to make it more specifically
> about the lies and exclusions of the media. Late capitalism has reformed
> education by exclusion, to such an extent that it increasingly moves resources
> away from history, the arts, and humanities. Instead, it focuses on STEM
> subjects and a vocational style of education most well suited to producing a
> specialized, short lived—and therefore disposable workforce rather than a
> civic-minded citizenry producing a public good.

## 178

A consciousness of history that threatens the spectacle is to discover the force
capable of reappropriating the environment to lived time. The proletarian
revolution is the _critique of human geography_, a critique of the environments,
...
dynamic and freely chosen. These open societies liberate authoritarian spaces,
...
> “reappropriating the environment to lived time”: The force of a consciousness
...
proletariat—a generalized and collective form of self-management of aligned
individuals working together to create a public good, a “generalized
self-management” according to the needs of the collective. The power of the
...
conditions if it is to be recognized and \_to recognize itself_in a world of its
own making.

> “anti-state dictatorship of the proletariat”: Debord specifically chose the
> phrase “la dictature anti-étatique du prolétariat” to cut through the
> ambiguities of Marx’s dictatorship of the proletariat, implemented by Stalin
> as a dictatorship _over_ the proletariat. His wording makes it very clear that
> he envisages a distinctly non-state form of social organization.
...
> proletariat”. See Raoul Vaneigem's "Notice to the Civilized Concerning
> Generalized Self-Management" in Knabb, K., 2006 (Pp. 363-371).
